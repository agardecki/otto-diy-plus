//----------------------------------------------------------------
//-- Otto DIY APP Firmware version V09 with standard baudrate of 9600 for Bluetooth modules
//-- This code will make Otto make all functions, you can reorganize moves, gestures or uncoment sings in the principal loop
//-- June 2019: Designed to work with the basic Otto but could be compatible with PLUS or Humanoid or other biped robots
/******************************************************************************************************
  Make sure to have installed all libraries: https://wikifactory.com/+OttoDIY/otto-diy-plus/
